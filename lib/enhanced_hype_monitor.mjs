...
class EnhancedHypeTradeMonitor {
  constructor() {
    ...
    this.dashboardApiUrl = process.env.NEXT_API_URL || 'http://localhost:3000/api/whales';
    ...
    this.whaleAddresses = [
      {
        address: "0x742d35Cc6635C0532925a3b8D8C6dA4a8b7b5C70",
        name: "Whale 1",
        portfolio: {},
        tags: ['known'],
        confidence: 90
  ...
  calculateTWAP(prices, period = 60) {
    if (prices.length < period) return null;
...
`;
  ...
  async monitorLoop() {
    ...
    try {
      ...
      // Calculate TWAP
      this.twap = this.calculateTWAP(this.priceHistory);
